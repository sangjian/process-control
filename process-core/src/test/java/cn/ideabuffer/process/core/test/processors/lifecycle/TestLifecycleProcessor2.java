 ...
 * @date 2021/06/27
 */
public class TestLifecycleProcessor2 implements Processor<String>, Lifecycle {
    ...
    public void initialize() {
        ...
        logger.info("TestLifecycleProcessor2 initializing");
    }

    @Override
    public void destroy() {
        destroyCounter.incrementAndGet();
        logger.info("TestLifecycleProcessor2 destroying");
    }
